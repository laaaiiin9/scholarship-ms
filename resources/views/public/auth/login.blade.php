            ...
            <div class="register-shell app-card app-card--shell">
                <div class="register-card app-card app-form-card h-100">
                    ...
                    <form id="loginForm" action="{{ route('auth.signIn') }}" method="POST" novalidate>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <label class="form-label register-label app-form-label" for="login_email">Email</label>
                                <input class="form-control register-input app-form-control" id="login_email" name="email"
                                    type="email" placeholder="Aria@gmail.com">
                            </div>

                            <div class="col-12">
                                <label class="form-label register-label app-form-label" for="login_password">Password</label>
                                <input class="form-control register-input app-form-control" id="login_password" name="password"
                        ...
                        <div class="register-actions app-form-actions">
                            ...
                            <a class="register-login-link app-form-link" href="{{ route('auth.register') }}">No account yet? Create one</a>
                        </div>
                    </form>
                </div>
            </div>
