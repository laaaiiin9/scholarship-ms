                            ...
                            <div class="d-flex flex-column flex-sm-row gap-3">
                                @auth
                                    @if (Auth::user()->hasRole('student'))
                                        <a class="btn btn-custom-primary text-white btn-hero-primary" href="{{ route('scholarships') }}">View My
                                            Applications</a>
                                        <a class="btn btn-light btn-hero-secondary" href="{{ route('scholarships') }}">Browse Scholarships</a>
                                    @else
