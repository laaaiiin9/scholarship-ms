...
@section('header_title', 'Scholarship Renewal Periods')
@section('title', 'Admin Renewal Periods')

@section('content')
<div class="container-fluid p-0">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        <div>
            <h4 class="fw-bold mb-1">Renewal Periods</h4>
            <p class="text-muted mb-0">Manage windows for existing scholars to renew their grants.</p>
        </div>
        ...
        <div class="card-body p-0 mt-3">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody class="border-top-0" id="renewal-periods-table-body">
                        <tr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header border-bottom-0 p-4 pb-0">
                <h5 class="modal-title fw-bold" id="periodModalLabel">New Renewal Period</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4 pt-2">
                <form id="renPeriodForm">
                    <input type="hidden" id="renPeriod_id" name="id">
            ...
            <div class="modal-footer border-top-0 p-4">
                ...
                <button type="button" class="btn btn-eskoylar-primary text-white px-4" id="saveRenPeriodBtn">Save Period Settings</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Delete Modal -->
<div class="modal fade" id="deleteRenPeriodModal" tabindex="-1" aria-labelledby="deletePeriodModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 text-center p-4">
            ...
            <div class="modal-body p-4 pb-5">
                ...
                <h4 class="fw-bold mb-2">Delete Renewal Period?</h4>
                <p class="text-muted mb-4">Deleting this renewal period will affect all active renewal submissions linked to it. This action cannot be undone.</p>
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn-outline-secondary px-5" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-danger px-5" id="confirmDeleteRenPeriodBtn">Yes, Delete</button>
                </div>
            </div>
        </div>
    </div>
