...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!tableBody && !composeForm) return;
    ...
    if (composeForm && sendBtn && composeModalEl) {
        ...
        const formService = new FormService({
            ...
            onSaved: () => {
                ...
                if (tableService) tableService.fetchData();
